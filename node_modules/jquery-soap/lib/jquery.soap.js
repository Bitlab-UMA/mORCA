...
//jQuery needs window with a document to initialize, so we create one with JSDOM
var jsdom = require("jsdom").jsdom;
var doc = jsdom();
var window = doc.defaultView;

//And we load jquery as a module
var $ = require("jquery")(window);


//I have put this here for access globally
var enableLogging;
var globalConfig = {
...
/*
* Now I have separate the funtion 'soap', which is the one we are going to use externally, and I have exported to be use
* in NodeJS. The rest of the code is exactly the same but out of the anonymous function.
* */

exports.soap = function (options) {
	var config = {};
